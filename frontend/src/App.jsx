  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/course-learning/:courseId" element={<ProtectedRoute role="student"><CourseLearning /></ProtectedRoute>} />
        <Route path="/student/progress" element={<ProtectedRoute role="student"><ProgressDashboard /></ProtectedRoute>} />
