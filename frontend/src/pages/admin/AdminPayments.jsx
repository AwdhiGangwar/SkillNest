      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="glass-card p-6 rounded-xl border border-surface-border">
            ...
            <h3 className="text-3xl font-bold text-emerald-400">${getTotalAmount()}</h3>
          ...
          <div className="glass-card p-6 rounded-xl border border-surface-border">
            ...
            <h3 className="text-3xl font-bold text-violet-400">99.8%</h3>
            <p className="text-slate-500 text-xs mt-2">Payment success</p>
          </div>
        </div>
